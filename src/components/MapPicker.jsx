    ...
    <div className={className}>
      <div className="relative overflow-hidden rounded-card border border-line">
        ...
        <button
          ...
          className="absolute right-3 top-3 z-[400] flex items-center gap-1.5 rounded-lg bg-ink-600/95 px-2.5 py-2 text-xs font-medium text-cream shadow-lg backdrop-blur hover:bg-ink-300"
        >
